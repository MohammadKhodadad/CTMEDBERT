...
from utils.contrastive_data_loader_ordered_minibatched import get_contrastive_dataloader
...
DS_CONFIG = {
    ...
    "scheduler": {
        ...
        "params": {
            "warmup_min_lr": 0,
            "warmup_max_lr": 0.000005,  # Max LR after warmup
...
train_loader = get_contrastive_dataloader('./data/csvs', tokenizer, batch_size=BATCH_SIZE,max_length=512)
...
for epoch in range(EPOCHS):
    ...
    for batch1, batch2 in progress_bar:
        ...
        if step % SAVE_STEP == 0:
            ...
            model.module.save_pretrained(f'./weights/contrastive_gte_17/ds_minibatched_step_{step}/')
